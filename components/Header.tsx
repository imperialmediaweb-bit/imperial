    ...
    <header className="sticky top-0 z-40 border-b border-bg-border/60 bg-bg/85 backdrop-blur-xl">
      <div className="container-app flex h-24 items-center justify-between sm:h-28 md:h-32">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link
            href="/brief"
            className="group inline-flex items-center gap-1.5 whitespace-nowrap rounded-full bg-orange-gradient px-3.5 py-2 text-xs font-semibold text-white shadow-glow-orange transition-all hover:scale-[1.03] hover:shadow-[0_0_45px_rgba(255,107,26,0.55)] sm:gap-2 sm:px-5 sm:py-3 sm:text-sm"
          >
            <Sparkles className="h-3.5 w-3.5 sm:h-4 sm:w-4" strokeWidth={2.5} />
            <span className="hidden min-[420px]:inline">Primește estimare</span>
            <span className="min-[420px]:hidden">Estimare</span>
          </Link>
