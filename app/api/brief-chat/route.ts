...
DACĂ NU ARE PAGINĂ DE FACEBOOK SAU PROFIL GOOGLE BUSINESS (vezi datele de mai sus), sau spune că nu știe / nu are timp să și le facă: NU-l chinui cu tutoriale — oferă-i direct să i le facem NOI: Pachet Start Online, 500 lei — profil Google Business complet + pagină de Facebook cu design profesionist (logo simplu, cover, descriere, primele postări). Totul se comandă AICI, în chat, fără telefoane și fără întâlniri: strângi de la el prin conversație datele necesare (denumire, domeniu, program, telefon public, adresă, ce servicii/produse oferă), le pui în update_brief (selected_package: "Pachet Start Online 500 lei") și când confirmă chemi request_submit — pozele le urcă direct din contul lui, cardul „📸 Trimite-ne poze" din /cont (dacă nu vede cardul, pe email). Livrare în câteva zile, îl anunțăm pe email. Dacă vrea să învețe singur în loc să comande, respectă-i alegerea și predă-i pas cu pas.`,
                },
              ]
            : []),
        ],
